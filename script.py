try:
    ...
    def transform_and_save(file_path):
        ...
        pattern_mocode_mapping = {
            ...
            #---------------------
            'VANDALISM - MISDEAMEANOR \(\$399 OR UNDER\)': '2304',
            'CRIMINAL THREATS - NO WEAPON DISPLAYED': '1900',
            'SEX OFFENDER REGISTRANT OUT OF COMPLIANCE': '0500',
            'THEFT-GRAND \(\$950.01 & OVER\)EXCPT,GUNS,FOWL,LIVESTK,PROD': '0300',
            'CHILD NEGLECT \(SEE 300 W.I.C.\)': '0500',
            'EMBEZZLEMENT, GRAND THEFT \(\$950.01 & OVER\)': '0300',
            'CRM AGNST CHLD \(13 OR UNDER\) \(14-15 & SUSP 10 YRS OLDER\)': '0500',
            'DOCUMENT WORTHLESS \(\$200 & UNDER\)': '0300',
            'FAILURE TO YIELD': '1900',
            'VEHICLE - ATTEMPT STOLEN': '1300',
            'TRESPASSING': '2304',
            'CHILD ABUSE \(PHYSICAL\) - AGGRAVATED ASSAULT': '0406',
            'DEFRAUDING INNKEEPER/THEFT OF SERVICES, OVER \$950.01': '0300',
            'DEFRAUDING INNKEEPER/THEFT OF SERVICES, \$950 & UNDER': '0300',
            'DEFRAUDING INNKEEPER/THEFT OF SERVICES, \$950 & UNDER': '0300',
            'DOCUMENT FORGERY / STOLEN FELONY': '1300',
            'DISCHARGE FIREARMS/SHOTS FIRED': '1900',
            'DRIVING WITHOUT OWNER CONSENT \(DWOC\)': '1300',
            'VANDALISM - FELONY \(\$400 & OVER, ALL CHURCH VANDALISMS\)': '2304',
            'UNAUTHORIZED COMPUTER ACCESS': '1900',
            'CHILD PORNOGRAPHY': '0500',
            'THEFT PLAIN - PETTY \(\$950 & UNDER\)': '0300',
            'CHILD ABUSE \(PHYSICAL\) - SIMPLE ASSAULT': '0416',
            'THEFT, PERSON': '1300',
            'VIOLATION OF COURT ORDER': '1501',
            'VIOLATION OF RESTRAINING ORDER': '1501',
            'HUMAN TRAFFICKING - INVOLUNTARY SERVITUDE': '1501',
            'CHILD STEALING': '1501',
            'THROWING OBJECT AT MOVING VEHICLE': '1300',
            'RESISTING ARREST': '1501',
            'VIOLATION OF TEMPORARY RESTRAINING ORDER': '1501',
            'DISTURBING THE PEACE': '1501',
            'EXTORTION': '1501',
            'CRIMINAL HOMICIDE': '1501',
            'THEFT PLAIN - ATTEMPT': '0300',
            'REPLICA FIREARMS\(SALE,DISPLAY,MANUFACTURE OR DISTRIBUTE\)': '1501',
            'CREDIT CARDS, FRAUD USE \(\$950 & UNDER': '1900',
            'ILLEGAL DUMPING': '1501',
            'FALSE POLICE REPORT': '1501',
            'CHILD ANNOYING \(17YRS & UNDER\)': '1501',
            'FALSE IMPRISONMENT': '1501',
            'CONTEMPT OF COURT': '1501',
            'HUMAN TRAFFICKING - COMMERCIAL SEX ACTS': '0500',
            'COUNTERFEIT': '1501',
            'CREDIT CARDS, FRAUD USE \(\$950.01 & OVER\)': '1900',
            'PROWLER': '1501',
            'CRUELTY TO ANIMALS': '0500',
            'SHOTS FIRED AT INHABITED DWELLING': '1100',
            'WEAPONS POSSESSION/BOMBING': '0300',
            'CONSPIRACY': '1500',
            'CONTRIBUTING': '1500',
            'DOCUMENT WORTHLESS \(\$200.01 & OVER\)': '0300',
            'PICKPOCKET': '2222',
            'SHOTS FIRED AT MOVING VEHICLE, TRAIN OR AIRCRAFT': '1100',
            'DISRUPT SCHOOL': '2300',
            'SODOMY/SEXUAL CONTACT B/W PENIS OF ONE PERS TO ANUS OTH': '0500',
            'PANDERING': '2300',
            'PIMPING': '0800',
            'PETTY THEFT - AUTO REPAIR': '0300',
            'EMBEZZLEMENT, PETTY THEFT \(\$950 & UNDER\)': '0300',
            'GRAND THEFT / INSURANCE FRAUD': '0300',
        }
        ...
        crmcd = {
            ...
            '845': 'Sexual Abuse', # Sex Offender Registrant Out Of Compliance.
            '745': 'Burglary',
            '740': 'Robbery',
            ...
            '940': 'Simple Assaults',
            '810': 'Sexual Abuse', # Sex;Unlawful(Inc Mutual Consent; Penetration W/ Frgn Obj
        ...
        mo_dict = {
        1: "Job",
        2: "Apply treatment", # For example: have some makeup, mask, halmet, etc.
        3: "Do some illegal action.", # snatch, vehicle shooting, ordered to do something.
        4: "Did crime", # bomb, grabed
        5: "Sexual act",
        6: "Business, Family, Traffic, Neighbour",
        7: "THEFT: Trick or Device",
        8: "Bunco",
        9: "Multi people, personal",
        10: "Smaller", #//
        11: "Shots Fired",
        12: "Defferent types of suspect",
        13: "Vehicle involved",
        14: "Forencic data, proves", # e.g photo, jewlery, semens.
        15: "Other MO (see rpt)",
        16: "Move something",
        17: "Elder Abuse",
        18: "Relationship",
        19: "Cybercrime",
        20: "DomesticV, LGBT, otherI", # Domestic violence, Other identity such as suspect was on wheelchair.
        21: "Suspicious",
        22: "Suspicious",
        23: "Suspicious",
        30: "Traffic Collision",
        31: "Traffic Collision",
        32: "Traffic Collision",
        33: "Traffic Collision",
        34: "Traffic Collision",
        35: "Traffic Collision",
        36: "Traffic Collision",
        37: "Traffic Collision",
        38: "Traffic Collision",
        39: "Traffic Collision",
        40: "Traffic Collision",
        44: "Traffic Collision",
        55: "Traffic Collision",
        66: "Traffic Collision",
        77: "Traffic Collision",
        88: "Traffic Collision",
        99: "Traffic Collision",
        }

    
        columns_to_map = ['Mocodes_1', 'Mocodes_2', 'Mocodes_3', 'Mocodes_4', 'Mocodes_5', 'Mocodes_6', 'Mocodes_7', 'Mocodes_8', 'Mocodes_9', 'Mocodes_10']
        for column in columns_to_map:
             df[column] = df[column].replace(mo_dict)
             if column == 'Mocodes_1':
                 df['Mocodes_1'] = df['Mocodes_1'].replace(0, pd.NA).fillna("Vehicle involved")

        # Fill 0 in Lat and Lon:
        
        df['LAT'] = df['LAT'].replace(0, pd.NA)

        # Step 2: Fill missing values in 'LAT' with corresponding values from 'AREA_NAME'
        df['LAT'] = df['LAT'].fillna(df.groupby('AREA_NAME')['LAT'].transform('first'))

        df['LON'] = df['LON'].replace(0, pd.NA)

        # Step 2: Fill missing values in 'LAT' with corresponding values from 'AREA_NAME'
        df['LON'] = df['LON'].fillna(df.groupby('AREA_NAME')['LAT'].transform('first'))
    ...
    file_path = r'D:\CrimeData\StagingArea\lacrime.csv'
